...
const INFO_CONTENT = `
<div class="map__info">
  <div class="map__info__card">
    <div class="map__info__header">
      <svg class="map__info__logo" viewBox="0 0 649 748" fill="none" xmlns="http://www.w3.org/2000/svg">
        ${ICON_INNER}
      </svg>
      <div>
    ...
    <div class="map__info__body">
      <div class="map__info__row">
        <div class="map__info__icon-box">
          <svg class="map__info__icon" viewBox="0 0 24 24">
      ...
      <div class="map__info__row map__info__row--top">
        <div class="map__info__icon-box">
          <svg class="map__info__icon" viewBox="0 0 24 24">
            <path class="map__info__icon-path" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
          </svg>
        </div>
        <div>
